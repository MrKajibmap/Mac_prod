%macro ABT_ML_TEMPERATURE(lib_out,tb_out);
	...
	data casuser.&tb_out._FL;
		...
		feature_nm='temp_month_avg'; feature_type = 'num'; use=1;output;
		feature_nm='temp_month_std'; feature_type = 'num'; use=1;output;
		feature_nm='temp_week_avg'; feature_type = 'num'; use=1;output;
		feature_nm='temp_week_std'; feature_type = 'num'; use=1;output;
		feature_nm='temperature'; feature_type = 'num'; use=1;output;
	run;
	proc casutil;
